...
BUNDLE_NAME=itc-pivotaltracker-bundle
BUNDLE_DESCRIPTION=ITCloud Pivotal Tracker Bundle
...
BUNDLE_CONSOLE_NAME=itc-pivotaltracker
...
BUNDLE_APIGEN_TITLE=${BUNDLE_DESCRIPTION} Source Code API
...
# ITC UML
BUNDLE_UML=${BUNDLE_SRC}/SK/ITCBundle/Resources/model/${BUNDLE_NAME}.xmi
